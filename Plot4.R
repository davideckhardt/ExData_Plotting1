...
dateTime <- dmy_hms(paste(powerData$Date, powerData$Time))
...
plot(dateTime, powerData$Sub_metering_1, type="l", ylab="Energy sub metering", xlab="", col=mycolors[1])
...
legend("topright", bty="o", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd=1, col=mycolors, cex = 0.4)
